...
public class Game2048 extends Game {
    ...
    private static final int MAX_TILE = 2048;
    private int score = 0;
    ...
    private void win() {
        showMessageDialog(getColorByValue(MAX_TILE), "YOU WIN!", Color.WHITE, 50);
        isGameStopped = true;
    }

    private void gameOver() {
        showMessageDialog(Color.RED, "YOU LOSE!", Color.WHITE, 50);
        isGameStopped = true;
    }
